...
public class DateMathParser  {
  ...
  private static Map<String,Integer> makeUnitsMap() {
    ...
    final Map<String,Integer> units = new HashMap<String,Integer>(13);
  ...
  public static void add(Calendar c, int val, String unit) {
    final Integer uu = CALENDAR_UNITS.get(unit);
    if (null == uu) {
  ...
  public Date parseMath(String math) throws ParseException {
    ...
    final Calendar cal = Calendar.getInstance(zone, loc);
    cal.setTime(getNow());
    ...
    final String[] ops = splitter.split(math);
    int pos = 0;
    while ( pos < ops.length ) {
      ...
      final char command = ops[pos++].charAt(0);
