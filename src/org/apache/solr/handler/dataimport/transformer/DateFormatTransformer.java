...
public class DateFormatTransformer extends Transformer {
  private final Map<String, SimpleDateFormat> fmtCache = new HashMap<String, SimpleDateFormat>();
  ...
  public Object transformRow(Map<String, Object> aRow, Context context) {
    ...
    for (final Map<String, String> map : context.getAllEntityFields()) {
      ...
      final String customLocale = map.get("locale");
      if(customLocale != null){
        locale = new Locale(customLocale);
      }

      final String fmt = map.get(DATE_TIME_FMT);
      if (fmt == null)
        continue;
      ...
      if (srcCol == null)
        srcCol = column;
      try {
        final Object o = aRow.get(srcCol);
        if (o instanceof List) {
          final List inputs = (List) o;
