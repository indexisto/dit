...
public class SolrInputField implements Iterable<Object>, Serializable
{
  ...
  public void setValue(Object v, float b) {
    ...
    if( v instanceof Object[] ) {
      ...
      final Collection<Object> c = new ArrayList<Object>( arr.length );
  ...
  public void addValue(Object v, float b) {
    if( value == null ) {
      if ( v instanceof Collection ) {
        final Collection<Object> c = new ArrayList<Object>( 3 );
        for ( final Object o : (Collection<Object>)v ) {
          c.add( o );
        }
        setValue(c, b);
      } else {
    ...
    if( v instanceof Iterable ) {
      for( final Object o : (Iterable<Object>)v ) {
        vals.add( o );
      }
    }
    else if( v instanceof Object[] ) {
      for( final Object o : (Object[])v ) {
        vals.add( o );
      }
    }
    else {
  ...
  public Object getFirstValue() {
    if( value instanceof Collection ) {
      final Collection c = (Collection<Object>)value;
      if( c.size() > 0 ) {
  ...
  public Collection<Object> getValues() {
    ...
    if( value != null ) {
      final Collection<Object> vals = new ArrayList<Object>(1);
      vals.add( value );
      return vals;
    }
    return null;
...
@SuppressWarnings("unchecked")
  ...
  public SolrInputField deepCopy() {
    final SolrInputField clone = new SolrInputField(name);
    clone.boost = boost;
    // We can't clone here, so we rely on simple primitives
    if (value instanceof Collection) {
      final Collection<Object> values = (Collection<Object>) value;
      final Collection<Object> cloneValues = new ArrayList<Object>(values.size());
